...
import (
	...
	versioned "github.com/pluralsh/trace-shield-controller/generated/client/clientset/versioned"
	...
	v1alpha1 "github.com/pluralsh/trace-shield-controller/generated/client/listers/observability/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ObservabilityV1alpha1().Configs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ObservabilityV1alpha1().Configs(namespace).Watch(context.TODO(), options)
			},
		},
