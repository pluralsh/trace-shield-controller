...
import (
	...
	scheme "github.com/pluralsh/trace-shield-controller/generated/client/clientset/versioned/scheme"
...
func newConfigs(c *ObservabilityV1alpha1Client, namespace string) *configs {
	return &configs{
		client: c.RESTClient(),
		ns:     namespace,
	}
