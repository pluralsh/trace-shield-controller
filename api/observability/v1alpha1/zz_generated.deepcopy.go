...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NotifBasicAuth) DeepCopyInto(out *NotifBasicAuth) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NotifBasicAuth.
func (in *NotifBasicAuth) DeepCopy() *NotifBasicAuth {
	if in == nil {
		return nil
	}
	out := new(NotifBasicAuth)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RelabelConfig) DeepCopyInto(out *RelabelConfig) {
	*out = *in
	if in.SourceLabels != nil {
		...
		*out = make([]*monitoringv1.LabelName, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(monitoringv1.LabelName)
				**out = **in
			}
		}
	}
