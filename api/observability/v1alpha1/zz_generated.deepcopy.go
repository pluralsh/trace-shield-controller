...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ForwardingRules) DeepCopyInto(out *ForwardingRules) {
	{
		in := &in
		*out = make(ForwardingRules, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ForwardingRules.
func (in ForwardingRules) DeepCopy() ForwardingRules {
	if in == nil {
		return nil
	}
	out := new(ForwardingRules)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *MimirLimits) DeepCopyInto(out *MimirLimits) {
	*out = *in
	...
	if in.NotificationRateLimitPerIntegration != nil {
		...
		*out = make(NotificationRateLimitMap, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in NotificationRateLimitMap) DeepCopyInto(out *NotificationRateLimitMap) {
	{
		in := &in
		*out = make(NotificationRateLimitMap, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NotificationRateLimitMap.
func (in NotificationRateLimitMap) DeepCopy() NotificationRateLimitMap {
	if in == nil {
		return nil
	}
	out := new(NotificationRateLimitMap)
	in.DeepCopyInto(out)
	return *out
}
